                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="name" required name="inp_email" type="email" placeholder="Enter your name..."
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="name" required name="inp_password" type="password" placeholder="Enter your name..."/>
