<section class="py-4">
    <div class="container px-5">
        <h1>ZONING CERTIFICATION</h1>
        <p>APPLICATION FOR ZONING CLEARANCE OF APPLICANT</p>
        <a href="/?menu-zoning" class="btn btn-default" style="margin-right: 10px;">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['list-zoning'])) {
                                    $list = $_GET['list-zoning'];
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="?zoning&id=<?= $row['req_id'] ?>" class="btn btn-success btn-sm">
