                                            ...
                                            if (isset($_GET['filter'])) {
                                                ...
                                                if ($search == "All") {
                                                    if (isset($_GET['from'])) {
                                                        $from = $_GET['from'];
                                                        $to = $_GET['to'];
                                                        $sql = "SELECT *FROM t_localize_info INNER JOIN ph_citymun ON local_citymun = citymunCode INNER JOIN ph_brgy ON local_brgy = brgyCode WHERE local_date BETWEEN '$from' AND '$to'";
                                                    } else {
                                                    ...
                                                    if (isset($_GET['from'])) {
                                                        $from = $_GET['from'];
                                                        $to = $_GET['to'];
                                                        $sql = "SELECT * FROM t_localize_info INNER JOIN ph_citymun ON local_citymun = citymunCode INNER JOIN ph_brgy ON local_brgy = brgyCode WHERE local_status = '$search' AND local_date BETWEEN '$from' AND '$to'";
                                                    } else {
                                                        $sql = "SELECT * FROM t_localize_info INNER JOIN ph_citymun ON local_citymun = citymunCode INNER JOIN ph_brgy ON local_brgy = brgyCode WHERE local_status = '$search'";
                                                    }
                                                }
                                            } else {
                                                $sql = "SELECT *FROM t_localize_info INNER JOIN ph_citymun ON local_citymun = citymunCode INNER JOIN ph_brgy ON local_brgy = brgyCode";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <a href="./pages/v1/localize/print.php?type=<?= $type ?>&filter=<?= $filter ?>&from=<?= $fromx ?>&to=<?= $tox ?>"
                                            ...
                                            <script>
                                                function range() {
                                                    ...
                                                    const link = '?generate-reports-localize&type=<?= $type ?>&filter=' + filter + '&from=' + from + '&to=' + to_date;
                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body">
                                    <div class="d-grid">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="?generate-reports-localize&type=<?= $type ?>&filter=All"
                                            ...
                                            <li>
                                                <a href="?generate-reports-localize&type=<?= $type ?>&filter=Pending"
                                                    class="btn btn-default btn-block" style="text-align: left;">
                                                    Pending - (<?= number_format($pending_count, 0) ?>)
                                                </a>
                                            </li>
                                            <li>
                                                <a href="?generate-reports-localize&type=<?= $type ?>&filter=Approved"
                                                    class="btn btn-default btn-block" style="text-align: left;">
                                                    Approved - (<?= number_format($approved_count, 0) ?>)
                                                </a>
                                            </li>
                                            <li>
                                                <a href="?generate-reports-localize&type=<?= $type ?>&filter=Declined"
                                                    class="btn btn-default btn-block" style="text-align: left;">
                                                    Declined - (<?= number_format($decline_count, 0) ?>)
                                                </a>
                                            </li>
                                            <li>
                                                <a href="?generate-reports-localize&type=<?= $type ?>&filter=Completed"
                                                    class="btn btn-default btn-block" style="text-align: left;">
                                                    Completed - (<?= number_format($completed_count, 0) ?>)
                                                </a>
                                            </li>
                                            <li>
                                                <a href="?generate-reports-localize&type=<?= $type ?>&filter=Released"
                                                    class="btn btn-default btn-block" style="text-align: left;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-4 mb-4">
                                <div class="col-lg-6 col-xl-6">
                                    <center>
                                        <a href="?generate-reports-localize&type=zoning" class="btn btn-default btn-block"
                                ...
                                <div class="col-lg-6 col-xl-6">
                                    <center>
                                        <a href="?generate-reports-localize&type=localize" class="btn btn-block btn-default"
                                            style="width: 95%; border: 1px solid #e1e1e1">
